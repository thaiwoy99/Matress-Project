...
const Product:React.FC <prodProp> = (props) => {
  ...
  return (
    <div className=' w-[90%] mx-auto  md:w-[40%] lg:w-[23%] mb-4 shadow-2xl rounded-xl md:h-[110vh] relative transform transition-transform duration-300 hover:scale-105 '>
        <div className='w-full h-[250px] mb-3 '>
            <img src={imgUrl} alt=""  className='w-full h-full rounded-t-xl'/>
        </div>
        <div className='pl-5 flex flex-col'>
        <p className='text-xl md:text-base font-medium mb-3 lg:text-xl'>{props.name}</p>
        ...
        <div className="pl-5">
        <button className="bg-gray-700 px-4 py-2 text-white rounded-md mb-7 hover:bg-gray-800 md:absolute bottom-0 ">View Products</button>
        </div>
